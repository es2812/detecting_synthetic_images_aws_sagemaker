...
To do this, we start with a pre-trained model, Inceptionv3 @he_2015_deep. I have chosen this model because it has very good top-1 accuracy, is available within Pytorch, and it is relatively light-weight compared to others, which will aid with time and budget constraints.
...
For this project I will use the CIFAKE dataset from Kaggle @bird_2024_cifake_kaggle. The CIFAKE dataset includes 60,000 examples of synthetically generated images labelled as FAKE, and another 60,000 examples of real images (collected from CIFAR-10).

This extensive dataset includes many high-quality synthetically generated images, as is shown in this image taken from the original paper the dataset was created for @bird_2024_cifake:
...
This is one of the final model architectures @bird_2024_cifake:
